<?php
   ...
   ?>
            ...
            <div class="page-breadcrumb">
               <div class="row">
                  <div class="col-5 align-self-center">
                     <h4 class="page-name">Master Kategori Mobil</h4>
                     ...
                     <div class="d-flex no-block justify-content-end align-items-center">
                        <nav aria-label="breadcrumb">
                           <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">Master Kategori Mobil</li>
                           </ol>
                        </nav>
                     </div>
                  </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header bg-info">
                                <h4 class="mb-0 text-white">Tambahkan Kategori mobil</h4>
                            </div>
                                <div class="card-body">
                                    <h4 class="card-title">Kategori Mobil</h4>
                                </div>
                                <hr>
                                <div class="form-body">
                                    <div class="card-body">
            ...
            function insert(){
                $.ajax({
                    url: ROOT+'admin_ajax/mastercarcategory_insert',
                    dataType: 'json',
                    type: 'post',
                    data: {
                        name: $('#name').val(),
                    ...
                    .done(function(data) {
                        ...
                        window.location = ROOT+'admin/mastercarcategory';
                    })
                    .always(function(){
            ...
            function update(){
                ...
                $.ajax({
                    url: ROOT+'admin_ajax/mastercarcategory_update',
                    dataType: 'json',
                    type: 'post',
                    data: {
                        name: $('#name').val(),
            ...
            function delete_(){
                ...
                $.ajax({
                    url: ROOT+'admin_ajax/mastercarcategory_delete',
                    dataType: 'json',
                    type: 'post',
                    data: {
                        id:id
