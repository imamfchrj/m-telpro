<?php
   ...
   ?>
                                        ...
                                        <div class="row pt-3">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="category_name" class="form-control" value="<?=$values->category_name?>" placeholder="">
                                                    <small class="form-control-feedback category_name-text"> </small> </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        <!--/row-->
            ...
            function insert(){
                $.ajax({
                    url: ROOT+'admin_ajax/kategoriberita_insert',
                    dataType: 'json',
                    type: 'post',
                    data: {
                    ...
                    .done(function(data) {
                        ...
                        window.location = ROOT+'admin/kategoriberita';
                    })
                    .always(function(){
            ...
            function update(){
                ...
                $.ajax({
                    url: ROOT+'admin_ajax/kategoriberita_update',
                    dataType: 'json',
                    type: 'post',
                    data: {
                        category_name: $('#category_name').val(),
            ...
            function delete_(){
                ...
                $.ajax({
                    url: ROOT+'admin_ajax/kategoriberita_delete',
                    dataType: 'json',
                    type: 'post',
                    data: {
                        id:id
